        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Your trusted partner for company formation in USA and UK. We provide comprehensive business setup services with maximum ROI for your investment.
            </p>
            <div className="space-y-1 text-gray-300 mb-6">
              <p className="font-semibold text-white">Eco Business Formation LTD</p>
              <p>124 City Rd, London EC1V 2NX, UK</p>
              <p>Mobile: <a href="tel:+13073721422" className="hover:text-white">+1(307)372-1422</a></p>
            </div>
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/share/19rwiQJdWC/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
              ...
              <a href="https://www.instagram.com/ecobusinessformationltd?igsh=aWdrcTcwaTFtOGI4" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
              ...
              <a href="https://wa.me/13073721422" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/services" className="text-gray-300 hover:text-white transition-colors">USA Company Formation</Link></li>
              <li><Link href="/services" className="text-gray-300 hover:text-white transition-colors">UK Company Formation</Link></li>
              <li><Link href="/services" className="text-gray-300 hover:text-white transition-colors">Bank Account Opening</Link></li>
              <li><Link href="/services" className="text-gray-300 hover:text-white transition-colors">Virtual Office</Link></li>
              <li><Link href="/services" className="text-gray-300 hover:text-white transition-colors">Tax Registration</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © <span suppressHydrationWarning>{currentYear}</span> Eco Business. All rights reserved.
            </p>
