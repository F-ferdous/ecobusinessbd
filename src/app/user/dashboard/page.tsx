          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="text-sm">
                {pkg ? `Package: ${pkg}` : "Order"} • Amount: {currency}{" "}
                {amount.toFixed(2)}
              </div>
              {saving && (
                <div className="text-xs mt-1">Saving your transaction...</div>
              )}
              {saveError && (
                <div className="text-xs text-red-600 mt-1">{saveError}</div>
              )}
            </div>
          </div>
        </div>
