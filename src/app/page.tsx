...
const PaymentMethodsMarquee = dynamic(() => import('@/components/PaymentMethodsMarquee'), {
  ssr: false,
  loading: () => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          <div className="text-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight animate-fadeInUp animate-stagger-1">
              ...
              <br />
              <span className="text-green-600">Formation Success</span>, Starting Today
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed animate-fadeInUp animate-stagger-2">
              Join thousands of successful entrepreneurs who trust Eco Business for their USA and UK 
              company formation needs. Fast, reliable, and cost-effective solutions with maximum ROI.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 animate-fadeInUp animate-stagger-3">
              <CTAButton href="#pricing" size="lg" className="px-8 py-4 hover:scale-105 transition-transform duration-200">
                Get Started
              </CTAButton>
              <CTAButton href="/contact" variant="outline" size="lg" className="px-8 py-4 hover:scale-105 transition-transform duration-200">
                ...
                <div className="bg-gray-50 px-6 py-4 border-b border-gray-200">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      ...
                      <span className="text-sm text-gray-600">Formation Dashboard</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6">
                  <div className="grid lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-1">
                      <div className="bg-gray-50 rounded-xl p-4">
                        <h3 className="text-sm font-semibold text-gray-700 mb-3">Formation Progress</h3>
                        <div className="space-y-3">
                          <div className="bg-white rounded-lg p-3">
                            <div className="flex items-center justify-between mb-2">
                              <span className="text-sm font-medium text-gray-900">Delaware LLC</span>
                              <span className="text-xs text-green-600 bg-green-100 px-2 py-1 rounded-full">Approved</span>
                            </div>
                            <div className="text-xs text-gray-500">Filed: Dec 15, 2024</div>
                          ...
                          <div className="bg-white rounded-lg p-3">
                            <div className="flex items-center justify-between mb-2">
                              <span className="text-sm font-medium text-gray-900">UK Ltd Company</span>
                              <span className="text-xs text-blue-600 bg-blue-100 px-2 py-1 rounded-full">Processing</span>
                            </div>
                            <div className="text-xs text-gray-500">Filed: Dec 18, 2024</div>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="lg:col-span-2">
                      <div className="bg-gray-50 rounded-xl p-4">
                        <h3 className="text-sm font-semibold text-gray-700 mb-3">Formation Analytics</h3>
                  ...
                  <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="text-center">
                      ...
                      <div className="text-xs text-gray-500">Companies Formed</div>
                    </div>
                    <div className="text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14 scroll-animate">
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
              Launch in days, not weeks. Pick your package, enter your details, and let our experts handle the rest.
              Transparent pricing, fast processing, and friendly support — from first click to final certificate.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="scroll-animate bg-white rounded-2xl border border-gray-100 shadow-sm p-6 hover:shadow-lg transition-shadow">
              <div className="w-12 h-12 rounded-xl bg-green-100 flex items-center justify-center mb-4">
                <svg className="w-7 h-7 text-green-600" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  <path strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M12 8v8m-4-4h8M21 12c0 4.97-4.03 9-9 9s-9-4.03-9-9 4.03-9 9-9 9 4.03 9 9z"/>
                </svg>
              </div>
              <h3 className="text-lg font-bold text-gray-900 mb-2">Guided, Step-by-Step</h3>
              <p className="text-gray-600 text-sm">Simple forms and clear guidance. We collect exactly what’s needed for a smooth, compliant filing.</p>
              <div className="mt-4 bg-gray-50 rounded-lg p-4 flex items-center justify-between">
                ...
                <span className="text-sm font-semibold text-green-700">5–7 minutes</span>
              </div>
            </div>
            ...
            <div className="scroll-animate bg-white rounded-2xl border border-blue-100 shadow-sm p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 text-sm">We file immediately and keep you updated. Most formations complete within 24–48 hours.</p>
            ...
            <div className="scroll-animate bg-white rounded-2xl border border-yellow-100 shadow-sm p-6 hover:shadow-lg transition-shadow">
              <div className="w-12 h-12 rounded-xl bg-yellow-100 flex items-center justify-center mb-4">
                <svg className="w-7 h-7 text-yellow-600" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  <path strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"/>
                </svg>
              </div>
              <h3 className="text-lg font-bold text-gray-900 mb-2">Everything You Need</h3>
              <p className="text-gray-600 text-sm">From registered agent to tax IDs and bank setup support — select add‑ons as you go. No hidden fees.</p>
              <ul className="mt-4 space-y-2 text-sm text-gray-700">
                <li className="flex items-center gap-2"><svg className="w-4 h-4 text-emerald-600" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7"/></svg>Registered agent (1 year)</li>
                <li className="flex items-center gap-2"><svg className="w-4 h-4 text-emerald-600" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7"/></svg>EIN/Tax IDs</li>
                <li className="flex items-center gap-2"><svg className="w-4 h-4 text-emerald-600" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7"/></svg>Bank account guidance</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 scroll-animate hover:scale-105 transition-transform duration-300">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-3">Trusted Experience</h3>
              <p className="text-gray-600 text-sm">
                Over 10 years of experience in international business formation with thousands of satisfied clients.
              </p>
            </div>
            ...
            <div className="text-center p-6 scroll-animate hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-gray-600 text-sm">
                Most companies formed within 24-48 hours. We handle all the paperwork so you can focus on your business.
              </p>
            </div>
            ...
            <div className="text-center p-6 scroll-animate hover:scale-105 transition-transform duration-300">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-3">Maximum ROI</h3>
              <p className="text-gray-600 text-sm">
                Competitive pricing with no hidden fees. Get the best value for your investment with our comprehensive packages.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join thousands of successful entrepreneurs who chose Eco Business for their company formation needs.
          </p>
