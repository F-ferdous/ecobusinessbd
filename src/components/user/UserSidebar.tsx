...
const navItems = [
  { label: "Dashboard", href: "/user/dashboard", color: "emerald", icon: (
  ...
  { label: "Purchases", href: "/user/dashboard/purchases", color: "sky", icon: (
      <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M3 7l9-4 9 4-9 4-9-4m0 6l9 4 9-4"/></svg>
    )},
  { label: "Transaction Packages", href: "/user/transactions", color: "indigo", icon: (
  ...
  { label: "Courses Enrolled", href: "/user/courses", color: "violet", icon: (
...
export default function UserSidebar({ open, onNavigate }: { open: boolean; onNavigate?: () => void }) {
      ...
      <div className="h-full p-4">
        <div className="h-full flex flex-col bg-white/95 backdrop-blur rounded-2xl shadow ring-1 ring-gray-100">
          <div className="px-5 pt-5 pb-4 border-b border-gray-100">
            <div className="text-lg font-semibold tracking-tight text-emerald-700">User Panel</div>
