          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 mt-3">
                Choose the perfect package for your UK business setup
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-gray-100 rounded-2xl shadow-md border border-gray-200 p-8 flex flex-col">
                ...
                <ul className="space-y-3 text-sm text-gray-700 flex-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Incorporation of Your Company</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1 inline-flex h-5 w-5 items-center justify-center rounded-full bg-green-600">
                      <svg
                    ...
                    <span>UK Registered Office Address for One Year.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1 inline-flex h-5 w-5 items-center justify-center rounded-full bg-green-600">
                      <svg
                    ...
                    <span>Directors Service Address for One year.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1 inline-flex h-5 w-5 items-center justify-center rounded-full bg-green-600">
                      <svg
                    ...
                    <span>Annual Compliance with Companies House</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1 inline-flex h-5 w-5 items-center justify-center rounded-full bg-green-600">
                      <svg
                    ...
                    <span>PSC Register with Companies House</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1 inline-flex h-5 w-5 items-center justify-center rounded-full bg-green-600">
                      <svg
                    ...
                    <span>Soft Copy of Certificate of Incorporation</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1 inline-flex h-5 w-5 items-center justify-center rounded-full bg-green-600">
                      <svg
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>Basic Tax Consultation</span>
                  </li>
                </ul>
                <Link
                  href="/purchase/uk/purchase?package=basic"
              ...
              <div className="relative bg-blue-50 rounded-2xl shadow-md border border-blue-300 p-8 flex flex-col">
                ...
                <ul className="space-y-3 text-sm text-gray-700 flex-1">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>Ultimate Beneficial Owner (UBO) Letter.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1 inline-flex h-5 w-5 items-center justify-center rounded-full bg-green-600">
                      <svg
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>Business Bank Account (Fintech)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1 inline-flex h-5 w-5 items-center justify-center rounded-full bg-green-600">
                      <svg
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>Business PayPal Account with Expert Hand</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1 inline-flex h-5 w-5 items-center justify-center rounded-full bg-green-600">
                      <svg
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>Basic Tax Consultations.</span>
                  </li>
                </ul>
                <Link
                  href="/purchase/uk/purchase?package=shopify-plus"
                  className="mt-8 inline-block w-full text-center bg-green-600 hover:bg-green-700 text-white font-semibold py-3 rounded-lg transition-colors"
                >
                  Order Now
                </Link>
              ...
              <div className="bg-gray-100 rounded-2xl shadow-md border border-gray-200 p-8 flex flex-col">
                <div className="text-center mb-6">
                  ...
                  <div className="mt-2">
                    <div className="flex items-baseline justify-center gap-3">
                      ...
                      <span className="text-gray-400 line-through">$649</span>
                    </div>
                  </div>
                </div>
                <ul className="space-y-3 text-sm text-gray-700 flex-1">
                ...
                <Link
                  href="/purchase/uk/purchase?package=premium"
                  className="mt-8 inline-block w-full text-center bg-green-600 hover:bg-green-700 text-white font-semibold py-3 rounded-lg transition-colors"
                >
                  Order Now
                </Link>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
              ...
              <div className="bg-gray-100 rounded-2xl shadow-md border border-gray-200 p-8 flex flex-col lg:col-start-2">
                ...
                <Link
                  href="/purchase/uk/purchase?package=standard"
                  className="mt-8 inline-block w-full text-center bg-green-600 hover:bg-green-700 text-white font-semibold py-3 rounded-lg transition-colors"
                >
                  Order Now
                </Link>
